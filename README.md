...
I’m a **high-volume builder, learner, experimenter, and documenter**. I don’t work in a single lane; I explore **many lanes in parallel**—data analytics, AI, dashboards, GenAI tools, web apps, cloud labs, business simulations, community leadership, content creation, research, and social impact.  

This GitHub is **not a polished senior engineer portfolio**. It’s a **living proof-of-work archive** showing scale, consistency, and obsessive learning.
...
- **Top 5% Google Arcade** | E-Cell IIT Bombay Participant | OSCI Devpost Contributor

---

## 🌍 Leadership & Community Impact

- **Founder – MetaMindset Labs**: Curating high-impact learning and AI experimentation.
- **Manager – DataFam Mumbai**: Leading community engagement for data enthusiasts in Mumbai.
- **Research Delegate – Aavishkar Research**: Specialized in Data Storytelling and complex visualization research.
- **McKinsey & Company – Forward Program**: Selected for the intensive leadership and business skills program.
- **LinkedIn Content Creator**: 1.5K+ followers and 200K+ impressions sharing daily data/AI insights.
...
## 📂 Repository Index (Proof of Work)

### 🤖 AI & Machine Learning
- **Study-buddy-AI**: AI assistant for agents (Devpost/Google Hackathon).
- **Ecommerce-sentiment-analysis**: Polarity classification using TextBlob.
- **Decision-Tree-Classifier**: ML implementation for predictive tasks.
- **Gyanankur-TF-IDF-Assignment-1**: Natural Language Processing logic.
- **Hack-the-Future-Gen-AI-Sprint**: Generative AI dashboard sprint deliverables.

### 📊 Data Analytics & Dashboards
- **Social-Media-Engagement-Dashboard**: Onyx Data Challenge (June 2025).
- **Mobile-Sales-Onyx-May-2025**: Deep-dive sales analytics and DAX.
- **Onyx-Data-Challenge-July-2025**: Customer Satisfaction & Loyalty project.
- **Pizza-Runner-Analytics**: End-to-end SQL case study for delivery operations.
- **Road-Accident-Analysis-Dashboard**: Visualizing 50K+ records for safety insights.
- **Weka-Hospital-Insights**: Healthcare data pattern mining.
- **FP20-Analytics-Challenge-27 & 28**: High-tier Power BI business reports.

### 💻 Web Development & Utilities
- **Recipe-sharing-platform**: Full-stack food community application.
- **Crafertube-Youtube-Clone**: Advanced frontend architecture.
- **GPB-Nexus**: Interactive roadmap platform for developers.
- **Chess-App / Chess-Analysis**: Strategic game UI and data analysis.
- **Secret-Code-Generator**: Python-based encryption/decryption tool.
- **Mean-variance-std**: Data logic for FreeCodeCamp certification.
...
## 🎓 Education
- **Thakur Shyamnarayan College, Mumbai** B.Sc. (Hons) Data Science (2024-2028) | **SGPA: 9.55 (Sem 1), 9.18 (Sem 2)**
- **N.L. Dalmia High School** Class 10th | **96.4%**
